      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 h-screen flex items-center">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 mb-16">
            ...
            <Button variant="outline" className="border-2 border-white/30 text-[#000000] hover:bg-white/10 font-['Montserrat',Helvetica] font-semibold text-lg px-8 py-6 h-auto rounded-full backdrop-blur-sm transition-all duration-300 hover:scale-105 group">
