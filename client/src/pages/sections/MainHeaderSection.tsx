...
export const MainHeaderSection = (): JSX.Element => {
  ...
  return (
    <header className="w-full h-[45px] bg-black flex items-center justify-between px-24">
      <div className="flex items-center gap-10">
        {/* PhoneIcon number */}
        <div className="flex items-center gap-2">
          <div className="w-[18px] h-[18px] bg-[url(/figmaAssets/phone-alt.svg)] bg-[100%_100%]" />
          <span className="font-['Montserrat',Helvetica] font-semibold text-white text-base">
            1-888-901-6468
          </span>
        </div>
